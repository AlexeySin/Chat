                        ...
                        <div class="form-group">
                            <select multiple class="form-control" id="exampleFormControlSelect2"
                                ...
                                @foreach($last as $key)
                                    ...
                                    @else
                                        <option class="alert alert-info" role="alert"><p>Отправитель
                                                - {{$current_user}}</p></option>
                                    @endif
                                    <option class="alert alert-info" role="alert"><p>Сообщение - {{$key["message"]}}</p>
                                    </option>
                                    <option class="alert alert-info" role="alert"><p>Время отправки сообщения
                                            - {{$key["time"]}}</p></option>
                                @endforeach
                            </select>
                        </div>
